        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Judge0LanguageId = table.Column<int>(type: "int", nullable: true),
                    TimeLimit = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionAnswers_InterviewSessions_InterviewSessionId",
                        column: x => x.InterviewSessionId,
                        principalTable: "InterviewSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionAnswers_McqOptions_SelectedOptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswers_InterviewSessionId_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswers_SelectedOptionId",
                table: "SessionAnswers",
